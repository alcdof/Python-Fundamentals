'''
beecrowd | 1005 | Average 1 | Adapted by Neilor Tonin, URI  Brazil | Timelimit: 1
...
Don't forget to print the end of line after the result, otherwise you will receive “Presentation Error”. Don't forget the space before and after 
the equal sign.
